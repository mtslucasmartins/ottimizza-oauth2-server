...
public interface ProductRepository extends JpaRepository<Product, BigInteger> {
    ...
    @Query(value = "select count(*) from products p inner join users_products up on (up.fk_users_id = :userId)", nativeQuery = true)
    public Short checkUserPermission(@Param("userId") BigInteger userId);
